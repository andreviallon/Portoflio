...
<div class="post-main-container col-xs-12">
    ...
    <div class="section-container col-sm-12 col-sm-offset-0 col-md-10 col-md-offset-1">
        <img src="https://www.andreviallon.com/wp-content/uploads/2018/03/Show-Case.png" alt="Findo Coffe App Show Case">
    </div>

    <!-- Persona-->
    <div class="section-container title-container col-md-8 col-md-offset-2">
        <h2 class="post-section-title">persona</h2>
        <p class="section-content">One of the first step I took was to create a persona to help me relate to the typical user of the app. The persona is based on my fellow design classmates, insights I gather across the web as well as my personal liking as I am part of the target group and I initially created this concept to solve a problem I often encounter.</p>
    </div>

    <div class="section-container col-sm-12 col-sm-offset-0 col-md-6 col-md-offset-3">
        <img src="https://www.andreviallon.com/wp-content/uploads/2018/03/Persona.png" alt="Findo Coffee Persona Arial Lustre">
    </div>
    ...
    <div class="section-container col-sm-12 col-sm-offset-0 col-md-10 col-md-offset-1">
        <img src="https://www.andreviallon.com/wp-content/uploads/2018/03/Fondo-Coffee-User-Journey.png" alt="User Journey">
    </div>

    <!--Site Map-->
    <div class="section-container col-sm-12 col-sm-offset-0 col-md-10 col-md-offset-1">
        <img src="https://www.andreviallon.com/wp-content/uploads/2018/03/Findo-Coffee-Site-Map.png" alt="Site Map">
    </div>
    ...
    <div class="section-container section-mobile col-sm-12 col-sm-offset-0 col-md-10 col-md-offset-1">
        <img class="col-xs-12 col-xs-offset-0 col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-0" src="https://www.andreviallon.com/wp-content/uploads/2018/03/Near-Me-Wireframes.png"
            alt="Findo Coffe Near Me Wireframe">
        <img class="col-xs-12 col-xs-offset-0 col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-0" src="https://www.andreviallon.com/wp-content/uploads/2018/03/Search-Wireframes.png"
            alt="Findo Coffe Search Wireframe">
        <img class="col-xs-12 col-xs-offset-0 col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-0" src="https://www.andreviallon.com/wp-content/uploads/2018/03/Details-Wireframes.png"
            alt="Findo Coffe Detail Wireframe">
    </div>
    ...
    <div class="section-container section-mobile col-sm-12 col-sm-offset-0 col-md-10 col-md-offset-1">
        <img class="col-xs-12 col-xs-offset-0 col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-0" src="https://www.andreviallon.com/wp-content/uploads/2018/03/Near-Me.png"
            alt="Findo Coffe Mockup Near Me">
        <img class="col-xs-12 col-xs-offset-0 col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-0" src="https://www.andreviallon.com/wp-content/uploads/2018/03/Search-Open.png"
            alt="Findo Coffe Mockup Search Opem">
        <img class="col-xs-12 col-xs-offset-0 col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-0" src="https://www.andreviallon.com/wp-content/uploads/2018/03/Details.png"
            alt="Findo Coffe Mockup Detail">
    </div>
